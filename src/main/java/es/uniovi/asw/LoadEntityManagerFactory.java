...
public class LoadEntityManagerFactory {
	...
	public static void main(String[] args) {
		EntityManagerFactory emf = Persistence.createEntityManagerFactory("citizensLoader");
		...
		// ent.find(Sustitucion.class, new SustitucionKey(3L,new
		// IntervencionKey(1L, 4L)));
